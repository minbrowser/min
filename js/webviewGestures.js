...
webviews.bindIPC("wheel-event", function (tabId, e) {
  ...
  var platformSecondaryKey =
    navigator.platform === "MacIntel" ? e.ctrlKey : false;
  ...
  if (Math.abs(e.deltaX) >= 20 || Math.abs(e.deltaY) >= 20) {
    ...
    swipeGestureLowVelocityTimeout = setTimeout(
      onSwipeGestureLowVelocity,
      swipeGestureVelocityDelay
    );

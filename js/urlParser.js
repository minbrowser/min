var urlParser = {
	...
	isUrl: function (url) {
		return url.indexOf("http://") == 0 || url.indexOf("https://") == 0 || url.indexOf("about:") == 0 || url.indexOf("chrome:") == 0 || url.indexOf("file://") == 0;
	},
	removeProtocol: function (url) {
		...
		var withoutProtocol = url.replace("http://", "").replace("https://", "").replace("file://", "").replace("chrome:", "");

...
const tabColor = {
  useSiteTheme: true,
  initialize: function () {
    webviews.bindEvent("page-favicon-updated", function (
      webview,
      tabId,
      favicons
    ) {
    ...
    webviews.bindEvent("did-change-theme-color", function (
      webview,
      tabId,
      color
    ) {
    ...
    if (tabColor.useSiteTheme) {
      ...
      if (tab.themeColor && tab.themeColor.color) {
        return setColor(
          ...
          tab.themeColor.textColor,
          tab.themeColor.isLowContrast
        );
      }
      ...
      if (tab.backgroundColor && tab.backgroundColor.color) {
        return setColor(
          ...
          tab.backgroundColor.textColor,
          tab.backgroundColor.isLowContrast
        );
      }
    }

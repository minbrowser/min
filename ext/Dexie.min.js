(function (n, t, i) {
  ...
  function u(n, t) {
    function cr() {
      b.on("versionchange", function () {
        b.close();
        b.on("error").fire(
          new nt("Database version changed by other database connection.")
        );
      });
    }
    function gi(n) {
    ...
    function lr(n, t, i, u) {
      ...
      if (n === 0)
        Object.keys(st).forEach(function (n) {
          ...
          (e = b._createTransaction(yt, fi, st)),
          (e.idbtrans = t),
          (e.idbtrans.onerror = o(i, ["populating database"])),
          e.on("error").subscribe(i),
          r.newPSD(function () {
            r.PSD.trans = e;
            try {
        ...
        st = b._dbSchema = s._cfg.dbschema;
        h = !1;
        l = ui.filter(function (t) {
          return t._cfg.version > n;
        });
        l.forEach(function (n) {
          ...
          u.add.forEach(function (n) {
            f.push(function (t, i) {
              nr(t, n[0], n[1].primKey, n[1].indexes);
              i();
            });
          });
          u.change.forEach(function (n) {
            if (n.recreate)
              throw new nt("Not yet support for changing primary key");
            else
              f.push(function (t, i) {
          ...
          n._cfg.contentUpgrade &&
            f.push(function (t, u) {
              var f, e;
              h = !0;
              f = b._createTransaction(
                yt,
                [].slice.call(t.db.objectStoreNames, 0),
                r
              );
              f.idbtrans = t;
              e = 0;
              f._promise = w(f._promise, function (n) {
              ...
              t.onerror = o(i, [
                "running upgrader function for version",
                n._cfg.version,
              ]);
      ...
      for (r in t)
        if (((e = n[r]), (o = t[r]), e))
          if (
            ...
            e.primKey.src !== o.primKey.src)
          )
            (i.recreate = !0), f.change.push(i);
          else {
    ...
    function nr(n, t, i, r) {
      var u = n.db.createObjectStore(
        t,
        i.keyPath
          ? { keyPath: i.keyPath, autoIncrement: i.auto }
    ...
    function vr(n, t) {
      Object.keys(n).forEach(function (i) {
        t.db.objectStoreNames.contains(i) ||
          nr(t, i, n[i].primKey, n[i].indexes);
      });
    }
    function yr(n, t) {
      for (var u, r = 0; r < t.db.objectStoreNames.length; ++r)
        (u = t.db.objectStoreNames[r]),
          (n[u] === null || n[u] === i) && t.db.deleteObjectStore(u);
    }
    function tr(n, t) {
    ...
    function pr(n, t) {
      throw new nt(
        "Table " +
          ...
          u.Promise.PSD.trans.scopeFunc.toString()
      );
    }
    function oi(n, t, i, r) {
      this.name = n;
    ...
    function ir(n, t, i, r) {
      ...
      for (
        this.db = b,
          ...
          r && (this.parent = r),
          this._tpf = o,
          this.tables = Object.create(di),
          f = t.length - 1;
        f !== -1;
        --f
      )
        (u = t[f]),
          (e = b._tableFactory(n, i[u], o)),
          (this.tables[u] = e),
          this[u] || (this[u] = e);
    }
    function li(n, t, i) {
    ...
    function ai(n, t) {
      ...
      this._ctx = {
        ...
        isPrimKey:
          !i.index ||
          (i.table.schema.primKey.keyPath &&
            i.index === i.table.schema.primKey.name),
        range: r,
        op: "openCursor",
        dir: "next",
        unique: "",
        ...
        n.split(",").forEach(function (n) {
          ...
          var i = n.replace("&", "").replace("++", "").replace("*", ""),
            r =
              i.indexOf("[") !== 0
                ? i
                : n.substring(n.indexOf("[") + 1, n.indexOf("]")).split("+");
          t.push(
            new a(
              i,
              r || null,
    ...
    function gr() {
      if (
        ((b.verno = it.version / 10),
        (b._dbSchema = st = {}),
        (fi = [].slice.call(it.objectStoreNames, 0)),
        fi.length !== 0)
      ) {
        var n = it.transaction(ot(fi), "readonly");
          ...
          for (
            var u,
              ...
              r = n.objectStore(t),
              i = r.keyPath,
              f = i && typeof i == "string" && i.indexOf(".") !== -1,
              h = new a(
                i,
                i || "",
                !1,
              ...
              o = [],
              e = 0;
            e < r.indexNames.length;
            ++e
          )
            (u = r.index(r.indexNames[e])),
              (i = u.keyPath),
              (f = i && typeof i == "string" && i.indexOf(".") !== -1),
              (s = new a(
                u.name,
    ...
    function or(n, t) {
      for (var i, r, u, o, s = t.db.objectStoreNames, f = 0; f < s.length; ++f)
        for (
          i = s[f], r = t.objectStore(i), u = 0;
          u < r.indexNames.length;
          ++u
        ) {
          var h = r.indexNames[u],
            e = r.index(h).keyPath,
            c =
              typeof e == "string" ? e : "[" + [].slice.call(e).join("+") + "]";
    ...
    this.version = function (n) {
      if (it) throw new nt("Cannot add version when database is open");
      this.verno = Math.max(this.verno, n);
      var t = ui.filter(function (t) {
        return t._cfg.version === n;
      })[0];
      return t ? t : ((t = new gi(n)), ui.push(t), ui.sort(wr), t);
    };
    s(gi.prototype, {
      stores: function (n) {
        var i, t;
        return (
          (this._cfg.storesSource = this._cfg.storesSource
            ? s(this._cfg.storesSource, n)
            : n),
          (i = {}),
          ui.forEach(function (n) {
            s(i, n._cfg.storesSource);
          }),
          (t = this._cfg.dbschema = {}),
          this._parseStoresSpec(i, t),
          (st = b._dbSchema = t),
          br([dt, b, di]),
          ur([di], pr, Object.keys(t), yt, t),
          ur(
            [dt, b, this._cfg.tables],
            b._transPromiseFactory,
            Object.keys(t),
            yt,
            t,
            !0
          ...
          k(function () {
            n(
              b._createTransaction(
                yt,
                Object.keys(t._cfg.dbschema),
                t._cfg.dbschema
              )
            );
          }),
          (this._cfg.contentUpgrade = n),
          this
        );
      },
        ...
        Object.keys(n).forEach(function (i) {
          if (n[i] !== null) {
            var u = {},
              f = kr(n[i]),
              r = f.shift();
            if (r.multi) throw new nt("Primary key cannot be multi-valued");
            r.keyPath && h(u, r.keyPath, r.auto ? 0 : r.keyPath);
    ...
    this._transPromiseFactory = function (n, t, i) {
      var f, u;
      return !hi || (r.PSD && r.PSD.letThrough)
        ? ((u = b._createTransaction(n, t, st)),
          u._promise(n, function (n, t) {
            u.error(function (n) {
              b.on("error").fire(n);
            });
            i(
        ...
        : (f = new r(function (r, u) {
            ri.push({
              resume: function () {
                var e = b._transPromiseFactory(n, t, i);
    ...
    this._whenReady = function (n) {
      return !e && hi && (!r.PSD || !r.PSD.letThrough)
        ? new r(function (t, i) {
            ri.push({
              resume: function () {
                n(t, i);
    ...
    this.open = function () {
      return new r(function (t, i) {
        ...
        if ((e && t(b), it || pi))
          throw new nt("Database already opened or being opened");
        var u,
          s = !1;
        try {
          if (((ei = null), (pi = !0), ui.length > 0 && (ci = !1), !vi))
            throw new nt(
              "indexedDB API not found. If using IE10+, make sure to run your code on a server URL (not locally). If using Safari, make sure to include indexedDB polyfill."
            );
          if (
            ((u = ci ? vi.open(n) : vi.open(n, Math.round(b.verno * 10))), !u)
          )
            throw new nt("IndexedDB API not available");
          ...
          u.onupgradeneeded = d(function (t) {
            ...
            ci && !b._allowEmptyDB
              ? ((u.onerror = function (n) {
                ...
                u.transaction.abort(),
                u.result.close(),
                (i = vi.deleteDatabase(n)),
                (i.onsuccess = i.onerror = function () {
                  f(new nt("Database '" + n + "' doesnt exist"));
                }))
              : (t.oldVersion === 0 && (s = !0),
                (u.transaction.onerror = o(f)),
                (r = t.oldVersion > Math.pow(2, 62) ? 0 : t.oldVersion),
                lr(r / 10, u.transaction, f, u));
          }, f);
          u.onsuccess = d(function () {
            pi = !1;
            it = u.result;
            ci
              ? gr()
              : it.objectStoreNames.length > 0 &&
                or(st, it.transaction(ot(it.objectStoreNames), ti));
            it.onversionchange = b.on("versionchange").fire;
            sr ||
              ft(function (t) {
    ...
    this.delete = function () {
      ...
      return new r(function (i, r) {
        ...
        if (t.length > 0) throw new nt("Arguments not allowed in db.delete()");
        pi ? ri.push({ resume: u }) : u();
      });
    };
    ...
    this.on.ready.subscribe = w(this.on.ready.subscribe, function (n) {
      return function (t, i) {
        function r() {
          return i || b.on.ready.unsubscribe(r), t.apply(this, arguments);
        }
        n.call(this, r);
        b.isOpen() && (hi ? ri.push({ resume: r }) : r());
      };
    });
    k(function () {
      b.on("populate").fire(b._createTransaction(yt, fi, st));
      b.on("error").fire(new nt());
    });
    this.transaction = function (n, t, i) {
      function s(t, e) {
        ...
        try {
          if (f) throw f;
          s = b._createTransaction(n, o, st, u);
          c = o.map(function (n) {
            return s.tables[n];
          });
          c.push(s);
          ...
          r.newPSD(function () {
            ...
            s.scopeFunc = i;
            u &&
              ((s.idbtrans = u.idbtrans),
              (s._promise = w(s._promise, function (n) {
          ...
          return typeof n == "string"
            ...
            : (n instanceof oi ||
                (f =
                  f ||
                  new yi(
                    "Invalid type. Arguments following mode must be instances of Table or String"
                  )),
              n.name);
        });
      return (
        n == "r" || n == ti
          ...
          : n == "rw" || n == yt
          ? (n = yt)
          : (f = new nt("Invalid transaction mode: " + n)),
        u &&
          (f ||
            (u &&
              u.mode === ti &&
    ...
    this.table = function (n) {
      if (e && ci) return new wi(n);
      if (!dt.hasOwnProperty(n)) throw new nt("Table does not exist");
      return dt[n];
    };
    s(oi.prototype, function () {
      ...
      return {
        ...
        get: function (n, t) {
          var i = this;
          return this._idbstore(ti, function (t, r, u) {
            e && t(i.schema.instanceTemplate);
            var f = u.get(n);
        ...
        each: function (n) {
          var t = this;
          return (
            e && n(t.schema.instanceTemplate),
            this._idbstore(ti, function (i, r, u) {
              var f = u.openCursor();
              f.onerror = o(r, ["calling", "Table.each()", "on", t.name]);
              bi(f, null, n, i, r, t.hook.reading.fire);
            })
          );
        },
        toArray: function (n) {
          var t = this;
          return this._idbstore(ti, function (n, i, r) {
            e && n([t.schema.instanceTemplate]);
            var u = [],
              f = r.openCursor();
        ...
        mapToClass: function (n, t) {
          ...
          return (
            ...
            t && ut(i, t),
            (this.schema.instanceTemplate = i),
            (r = function (t) {
              var r, i;
              if (!t) return t;
      ...
      .extend(function () {
        return {
          add: function (n, t) {
            ...
            return this._idbstore(yt, function (e, s, l, a) {
              var v = {},
                ...
                p;
              r !== f &&
                ((w = t || (l.keyPath ? c(n, l.keyPath) : i)),
                (y = r.call(v, w, n, a)),
                w === i &&
                  y !== i &&
                  (l.keyPath ? h(n, l.keyPath, y) : (t = y)));
              ...
              p.onsuccess = function (t) {
                var i = l.keyPath;
                if ((i && h(n, i, t.target.result), v.onsuccess))
                  v.onsuccess(t.target.result);
                e(p.result);
              };
            });
          },
          put: function (n, t) {
            ...
            return u !== f || e !== f
              ? this._trans(yt, function (u, f, e) {
                  var o =
                    t ||
                    (r.schema.primKey.keyPath &&
                      c(n, r.schema.primKey.keyPath));
                  o === i
                    ? e.tables[r.name].add(n).then(u, f)
                    : (e._lock(),
                      (n = l(n)),
                      e.tables[r.name]
                        .where(":id")
          ...
          delete: function (n) {
            return this.hook.deleting.subscribers.length
              ...
              : this._idbstore(yt, function (t, i, r) {
                  var u = r.delete(n);
          ...
          clear: function () {
            return this.hook.deleting.subscribers.length
              ...
              : this._idbstore(yt, function (n, t, i) {
                  var r = i.clear();
          ...
          update: function (n, t) {
            ...
            return (
              u === i &&
                r.reject(new nt("Object does not contain its primary key")),
              this.where(":id").equals(u).modify(t)
            );
          },
        };
      });
    s(ir.prototype, {
      _lock: function () {
        return (
          ++this._reculock,
          this._reculock === 1 && r.PSD && (r.PSD.lockOwnerFor = this),
          this
        );
      },
      _unlock: function () {
            ...
            f._locked()
              ...
              : ((e = f.active
                  ? new r(function (r, e) {
                      if (!f.idbtrans && n) {
                        if (!it)
                          throw ei
                            ? new nt(
                                "Database not open. Following error in populate, ready or upgrade function made Dexie.open() fail: " +
                                  ei
                              )
                            : new nt("Database not open");
                        var o = (f.idbtrans = it.transaction(
                          ot(f.storeNames),
                          f.mode
                        ));
                        ...
                        o.onabort = function (n) {
                          y(function () {
                            f.on("error").fire(
                              new nt("Transaction aborted for unknown reason")
                            );
                          });
                          f.active = !1;
                          f.on("abort").fire(n);
                  ...
                  : r.reject(
                      ni(
                        new nt(
                          "Transaction is inactive. Original Scope Function Source: " +
                            f.scopeFunc.toString()
                        )
                      )
                    )),
                f.active &&
      ...
      abort: function () {
        if (this.idbtrans && this.active)
          try {
            this.active = !1;
            this.idbtrans.abort();
            this.on.error.fire(new nt("Transaction Aborted"));
          } catch (n) {}
      },
      table: function (n) {
        if (!this.tables.hasOwnProperty(n))
          throw new nt("Table " + n + " not in transaction");
    ...
    s(li.prototype, function () {
      ...
      function t(n) {
        return Array.prototype.slice.call(
          n.length === 1 && Array.isArray(n[0]) ? n[0] : n
        );
      }
      function r(n) {
        return n === "next"
      ...
      function f(n, t, i, r, u, f) {
        for (
          var h, s = Math.min(n.length, r.length), o = -1, e = 0;
          e < s;
          ++e
        ) {
          if (((h = t[e]), h !== r[e]))
            return u(n[e], i[e]) < 0
              ? n.substr(0, e) + i[e] + i.substr(e + 1)
              : u(n[e], r[e]) < 0
              ? n.substr(0, e) + r[e] + i.substr(e + 1)
              : o >= 0
              ? n.substr(0, o) + t[o] + i.substr(o + 1)
              : null;
          u(n[e], h) < 0 && (o = e);
        }
        return s < r.length && f === "next"
          ? n + i.substr(n.length)
          : s < n.length && f === "prev"
          ? n.substr(0, i.length)
          : o < 0
          ? null
          : n.substr(0, o) + r[o] + i.substr(o + 1);
      }
      function i(n, t, i) {
        function a(n) {
          s = r(n);
      ...
      return {
        between: function (n, t, i, r) {
          ...
          (r = r === !0),
          n > t || (n === t && (i || r) && !(i && r)))
            ? new this._ctx.collClass(this, function () {
                return kt.only(n);
              }).limit(0)
            : new this._ctx.collClass(this, function () {
        ...
        startsWith: function (t) {
          return typeof t != "string"
            ? n(new this._ctx.collClass(this), new yi("String expected"))
            : this.between(t, t + String.fromCharCode(65535), !0, !0);
        },
        startsWithIgnoreCase: function (t) {
          if (typeof t != "string")
            return n(new this._ctx.collClass(this), new yi("String expected"));
          if (t === "") return this.startsWith(t);
          var r = new this._ctx.collClass(this, function () {
            return kt.bound(
              t.toUpperCase(),
              t.toLowerCase() + String.fromCharCode(65535)
            );
          });
          return (
            i(
            ...
            (r._ondirectionchange = function () {
              n(
                r,
                new nt(
                  "reverse() not supported with WhereClause.startsWithIgnoreCase()"
                )
              );
            }),
            r
        ...
        anyOf: function () {
          var f = this._ctx,
            ...
            u,
            r;
          return (n.sort(i), n.length === 0)
            ? new this._ctx.collClass(this, function () {
                return kt.only("");
              }).limit(0)
            : ((u = new this._ctx.collClass(this, function () {
              ...
              (r = 0),
              u._addAlgorithm(function (t, u, f) {
                for (var e = t.key; i(e, n[r]) > 0; )
          ...
          return i.every(function (n) {
            ...
            ? i.length === 0
              ...
              : ((f = i.map(function (n) {
                ...
                (r = 0),
                (e = h),
                (o = new s.collClass(this, function () {
                  return kt.bound(
                    i[0],
                    i[i.length - 1] + String.fromCharCode(65535)
                  );
                })),
                (o._ondirectionchange = function (n) {
                  n === "next" ? ((e = h), (u = ii)) : ((e = c), (u = fr));
                  i.sort(u);
                  f.sort(u);
                }),
                o._addAlgorithm(function (n, t, o) {
                  for (var s = n.key; e(s); )
                    if ((++r, r === i.length)) return t(o), !1;
                  return s >= i[r] && s <= f[r]
                    ? (t(function () {
                        n.continue();
                      }),
                ...
                o)
            : n(
                new s.collClass(this),
                new yi("startsWithAnyOf() only works with strings")
              );
        },
      };
    });
    s(ai.prototype, function () {
        ...
        n.or
          ? (function () {
              ...
              var o = n.filter,
                ...
                c = 0;
              n.or._iterate(h, e, r, u);
              bi(f(n, u), n.algorithm, h, e, r, n.table.hook.reading.fire);
            })()
          : bi(
              f(n, u),
              ki(n.algorithm, n.filter),
              t,
              i,
              r,
              n.table.hook.reading.fire
            );
      }
      function t(n) {
      ...
      return {
        _read: function (n, t) {
          var i = this._ctx;
          return i.error
            ? i.table._trans(null, function (n, t) {
                t(i.error);
              })
        ...
        _write: function (n) {
          var t = this._ctx;
          return t.error
            ? t.table._trans(null, function (n, i) {
                i(t.error);
              })
          ...
          return e
            ...
            : ((s = this),
              ...
              t.filter || t.algorithm || t.or
                ...
                : this._read(function (n, i, r) {
                    var f = u(t, r),
                      e = t.range ? f.count(t.range) : f.count();
                    e.onerror = o(i, ["calling", "count()", "on", s.name]);
                    e.onsuccess = function (i) {
                      n(
                        Math.min(
                          i.target.result,
                          Math.max(0, t.limit - t.offset)
                        )
                      );
                    };
                  }, n));
        ...
        sortBy: function (n, t) {
          ...
          function o(n, t) {
            var i = r(n, u),
              e = r(t, u);
            return i < e ? -f : i > e ? f : 0;
          }
          var s = this._ctx,
            i = n.split(".").reverse(),
            e = i[0],
            u = i.length - 1,
            f = this._ctx.dir === "next" ? 1 : -1;
        ...
        toArray: function (n) {
          var r = this._ctx;
          return this._read(function (n, u, f) {
            e && n([t(r)]);
            var o = [];
            i(
              r,
            ...
            e &&
              n(
                c(
                  t(this._ctx),
                  this._ctx.index
                    ? this._ctx.table.schema.idxByName[this._ctx.index].keyPath
                    : this._ctx.table.schema.primKey.keyPath
                )
              ),
            i.isPrimKey || (i.op = "openKeyCursor"),
        ...
        keys: function (n) {
          var i = this._ctx,
            t;
          return (i.isPrimKey || (i.op = "openKeyCursor"), (t = []), e)
            ? new r(this.eachKey.bind(this))
                .then(function (n) {
                  return [n];
                })
                .then(n)
          ...
          return (
            ...
            this._write(function (r, e, v, y) {
              function st(n, i) {
                ...
                if (
                  ((et = i.primaryKey),
                  (r = { primKey: i.primaryKey, value: n }),
                  w.call(r, n) !== !1)
                )
                  (u = !r.hasOwnProperty("value")),
                    (f = u ? i.delete() : i.update(r.value)),
                    ++ut,
                    (f.onerror = o(
                      function (n) {
                        if ((p.push(n), nt.push(r.primKey), r.onerror))
                          r.onerror(n);
                        return tt(), !0;
                      },
                      u
                        ? ["deleting", n, "from", t.table.name]
                        : ["modifying", n, "on", t.table.name]
                    )),
                    (f.onsuccess = function () {
              ...
              function ot(n) {
                return (
                  n && (p.push(n), nt.push(et)),
                  e(new g("Error modifying one or more objects", p, b, nt))
                );
              }
              function tt() {
                    ...
                    i === f && u === f
                      ...
                      : function (t) {
                          ...
                          this.hasOwnProperty("value")
                            ? ((e = gt(f, this.value)),
                              (r = i.call(this, e, this.primKey, f, y)),
                              r &&
                                ((t = this.value),
    ...
    return n === f
      ...
      : function () {
          ...
          return (
            ...
            r && (this.onsuccess = this.onsuccess ? b(r, this.onsuccess) : r),
            u && (this.onerror = this.onerror ? b(u, this.onerror) : u),
            e !== i ? e : f
          );
        };
  }
    ...
    return n === f
      ...
      : function () {
          ...
          return (
            ...
            f && (this.onsuccess = this.onsuccess ? b(f, this.onsuccess) : f),
            e && (this.onerror = this.onerror ? b(e, this.onerror) : e),
            r === i ? (u === i ? i : u) : u === i ? r : s(r, u)
          );
        };
  }
  function yt(n, t) {
    return n === f
      ? t
      : function () {
          return n.apply(this, arguments) === !1
            ? !1
            : t.apply(this, arguments);
        };
  }
  ...
  function c(n, t) {
    ...
    return ((u = t.indexOf(".")), u !== -1)
      ? ((e = n[t.substr(0, u)]), e === i ? i : c(e, t.substr(u + 1)))
      : i;
  }
  function h(n, t, r) {
    var u, c, e, f, s, o;
    if (n && t !== i)
      if (typeof t != "string" && "length" in t)
        for (
          kt(typeof r != "string" && ("length" in r)), u = 0, c = t.length;
          u < c;
          ++u
        )
          h(n, t[u], r[u]);
  ...
  function gt(n, t) {
    ...
    for (var r in n)
      n.hasOwnProperty(r) &&
        (t.hasOwnProperty(r)
          ? n[r] !== t[r] &&
            JSON.stringify(n[r]) != JSON.stringify(t[r]) &&
            (u[r] = t[r])
          : (u[r] = i));
  ...
  var r = (function () {
      ...
      function p() {
        var r = u,
          ...
          f,
          i;
        for (u = [], t = 0, f = r.length; t < f; ++t)
          (i = r[t]), i[0].apply(n, i[1]);
      }
      function t(n) {
      ...
      function s(n, f) {
        ...
        if (((h = n._state ? f.onFulfilled : f.onRejected), h === null))
          return (n._state ? f.resolve : f.reject)(n._value);
        a = r;
        r = !1;
        i = l;
        try {
          ...
          s = h(n._value);
          n._state ||
            (s && typeof s.then == "function" && s._state === !1) ||
            w(n);
          f.resolve(s);
        } catch (y) {
          if (((b = f.reject(y)), !b && n.onuncatched))
            try {
              n.onuncatched(y);
            } catch (y) {}
        } finally {
      ...
      function b() {
        for (var n = 0, t = this._deferreds.length; n < t; n++)
          s(this, this._deferreds[n]);
        this._deferreds = [];
      }
      function y(n, t, i, r) {
      ...
      return (
        ...
        (t.prototype.then = function (n, r) {
          ...
          return (
            (u._PSD = this._PSD),
            (u.onuncatched = this.onuncatched),
            (u._parent = this),
            u
          );
        }),
  ...
  u.spawn = function () {
    return (
      n.console &&
        console.warn(
          "Dexie.spawn() is deprecated. Use Dexie.ignoreTransaction() instead."
        ),
      u.ignoreTransaction.apply(this, arguments)
    );
  };
  u.vip = function (n) {
    return r.newPSD(function () {
  ...
  u.deepClone = l;
  u.addons = [];
  u.fakeAutoComplete = k;
  u.asap = y;
  u.ModifyError = g;
  u.MultiModifyError = g;
  u.IndexSpec = a;
  u.TableSchema = et;
  nt = n.idbModules && n.idbModules.shimIndexedDB ? n.idbModules : {};
  u.dependencies = {
    indexedDB:
      nt.shimIndexedDB ||
      n.indexedDB ||
      ...
      n.webkitIndexedDB ||
      n.msIndexedDB,
    IDBKeyRange: nt.IDBKeyRange || n.IDBKeyRange || n.webkitIDBKeyRange,
    IDBTransaction:
      nt.IDBTransaction || n.IDBTransaction || n.webkitIDBTransaction,

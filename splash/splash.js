...
var platformMatchStrings = {
  'MacIntel': 'https://github.com/minbrowser/min/releases/download/v1.11.1/Min-v1.11.1-darwin-x64.zip',
  ...
  'Linux i686': 'https://github.com/minbrowser/min/releases/download/v1.11.1/min_1.11.1_amd64.deb',
  'x86_64': 'https://github.com/minbrowser/min/releases/download/v1.11.1/min_1.11.1_amd64.deb'
}

// matches against navigator.userAgent
var UAMatchStrings = {
  'Win64': 'https://github.com/minbrowser/min/releases/download/v1.11.1/min-1.11.1-setup.exe',
  'WOW64': 'https://github.com/minbrowser/min/releases/download/v1.11.1/min-1.11.1-setup.exe',
  // neither of the 64-bit strings matched, fall back to 32-bit
  'Windows NT': 'https://github.com/minbrowser/min/releases/download/v1.11.1/Min-v1.11.1-win32-ia32.zip'
}

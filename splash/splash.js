...
var platformMatchStrings = {
  'MacIntel': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min-v1.8.0-darwin-x64.zip',
  'Linux i686': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min_1.8.0_i386.deb',
  'x86_64': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min_1.8.0_amd64.deb'
}

// matches against navigator.userAgent
var UAMatchStrings = {
  'Win64': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min-v1.8.0-win32-x64.zip',
  'WOW64': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min-v1.8.0-win32-x64.zip',
  // neither of the 64-bit strings matched, fall back to 32-bit
  'Windows NT': 'https://github.com/minbrowser/min/releases/download/v1.8.0/Min-v1.8.0-win32-ia32.zip'
}
